/obj/item/gun/projectile/automatic/smg
	...
	firemodes = list(
		...
		list(mode_name="full auto",      burst=1,    fire_delay=0,    burst_delay=1,       one_hand_penalty=5,             burst_accuracy = list(-1,-1,-1), dispersion=list(0.6, 0.6, 1.0), autofire_enabled=1)
	)
